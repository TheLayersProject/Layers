...
namespace Layers
{
	...
	/*!
		A Layers LApplication is a QApplication and a LThemeable that provides
		...
		LUpdateDialog to the user which alerts them and asks if they would like
		...
		LMainWindow.
	*/
	class LAYERS_WIDGETS_EXPORT LApplication : public QApplication, public LThemeable
	{
		Q_OBJECT
	...
	public:
		...
		*/
		...
		/*!
			...
			The QMap contains QString-LTheme* pairs where the QString matches
