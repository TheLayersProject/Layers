...
{
	/*!
		A LLabel is a QLabel and a LThemeable that is used to display text or a
		LGraphic.
	*/
	class LAYERS_WIDGETS_EXPORT LLabel : public QLabel, public LThemeable
	{
		Q_OBJECT
	...
	public:
		...
		*/
		...
		/*!
			...
			a pointer to the LSvgRenderer, if the label uses a graphic that has
			one.
		*/
	...
	private:
		...
		LAttribute* m_fill{
			new LAttribute("fill", QColor(Qt::white), true) };
