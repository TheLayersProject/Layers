...
{
	/*!
		A LColorPlane is a QWidget that serves as a two-dimensional slider for
		selecting a color from an HSV cylinder.

		The %LColorPlane can only represent two dimensions of an HSV cylinder
	...
	*/
	class LAYERS_WIDGETS_EXPORT LColorPlane : public QWidget
	{
		Q_OBJECT
