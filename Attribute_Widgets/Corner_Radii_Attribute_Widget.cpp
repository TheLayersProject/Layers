...
using Layers::Corner_Radii_Attribute_Widget;
using Layers::Theme;

Corner_Radii_Attribute_Widget::Corner_Radii_Attribute_Widget(Themeable* themeable, bool is_primary, QWidget* parent) :
	m_attribute_widget{ new Attribute_Widget(is_primary) }, Attribute_Widget_Container("Corner Radii", is_primary, parent)
{
	...
	{
		Stateful_Attribute* corner_radius_tl_atribute = themeable->attribute_set().stateful_attribute("corner_radius_tl");
		Stateful_Attribute* corner_radius_tr_atribute = themeable->attribute_set().stateful_attribute("corner_radius_tr");
		Stateful_Attribute* corner_radius_bl_atribute = themeable->attribute_set().stateful_attribute("corner_radius_bl");
		Stateful_Attribute* corner_radius_br_atribute = themeable->attribute_set().stateful_attribute("corner_radius_br");
...
void Corner_Radii_Attribute_Widget::apply_theme(Theme& theme)
{
...
void Corner_Radii_Attribute_Widget::update_customizing_state(const QString& customizing_state)
{
	if (m_customize_states.contains(customizing_state))
	{
		Stateful_Attribute* corner_radius_tl_atribute = m_tl_line_editor_asc->to_stateful_attribute();
		Stateful_Attribute* corner_radius_tr_atribute = m_tr_line_editor_asc->to_stateful_attribute();
		Stateful_Attribute* corner_radius_bl_atribute = m_bl_line_editor_asc->to_stateful_attribute();
		Stateful_Attribute* corner_radius_br_atribute = m_br_line_editor_asc->to_stateful_attribute();
...
void Corner_Radii_Attribute_Widget::init_child_themeable_reference_list()
{
...
void Corner_Radii_Attribute_Widget::setup_layout()
{
