	...
	: QWidget(parent)
{
	...
	connect(this, &ColorPlane::active_mode_changed,
		this, &ColorPlane::update_z_value);
}
...
{
	connect(&m_z_value, &Attribute::changed, [this] {
		QColor c = m_color.as<QColor>();
	...
	m_cursor->fill()->entangle_with(m_color);
