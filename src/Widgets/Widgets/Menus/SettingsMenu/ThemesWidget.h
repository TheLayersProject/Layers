...
namespace Layers
{
	...
	private:
		...
		Button* m_new_theme_button{
			new Button(Graphic(":/images/new_theme.svg", QSize(20, 20))) };
		
		Button* m_customize_theme_button{
			new Button(Graphic(":/images/customize_theme.svg", QSize(20, 20))) };
		
		Button* m_delete_theme_button{
			new Button(Graphic(":/images/delete_theme.svg", QSize(17, 20))) };
		
		Button* m_theme_info_button{
			new Button(Graphic(":/images/info_theme.svg", QSize(20, 20))) };
