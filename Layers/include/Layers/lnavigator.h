...
/*!
	An LNavigator is a QWidget and a LThemeable that provides the user with a
	set of text-buttons that represent items of a hierarchy. The buttons can be
	clicked to navigate between the hierarchy of items.
*/
class LAYERS_EXPORT LNavigator : public QWidget, public LThemeable
{
	Q_OBJECT
